classdef Squeeze_To_SigmoidLayer1003 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods(Static, Hidden)
        ...
        function name = matlabCodegenRedirect(~)
            name = 'test_model.coder.Squeeze_To_SigmoidLayer1003';
        end
    end
    ...
    methods
        ...
        function [type, distance] = predict(this, functional_1_conv_16, functional_1_globa_1, functional_1_globa_3, functional_1_globa_1NumDims, functional_1_globa_3NumDims)
            ...
            functional_1_globa_1 = test_model.ops.permuteInputVar(functional_1_globa_1, ['as-is'], 0);
        ...
        function [type, distance, typeNumDims1015, distanceNumDims1016] = Squeeze_To_SigmoidGraph1011(this, functional_1_conv_16, functional_1_globa_1, functional_1_globa_3, functional_1_conv_16NumDims, functional_1_globa_1NumDims, functional_1_globa_3NumDims, Training)
            ...
            % Squeeze:
            [functional_1_conv_15, functional_1_conv_15NumDims] = test_model.ops.onnxSqueeze(functional_1_conv_16, this.Vars.axes_const__2036__20, functional_1_conv_16NumDims);

            % Add:
            functional_1_conv_12 = functional_1_conv_15 + this.Vars.const_fold_opt__2098;
            functional_1_conv_12NumDims = max(functional_1_conv_15NumDims, this.NumDims.const_fold_opt__2098);
            ...
            % Transpose:
            [perm, Transpose__2072_0NumDims] = test_model.ops.prepareTransposeArgs(this.Vars.TransposePerm1012, functional_1_conv_13NumDims);
            if isempty(perm)
                Transpose__2072_0 = functional_1_conv_13;
            else
                Transpose__2072_0 = permute(functional_1_conv_13, perm);
            end

            % ReduceMax:
            dims = test_model.ops.prepareReduceArgs(this.Vars.ReduceMaxAxes1013, Transpose__2072_0NumDims);
            xMax = max(Transpose__2072_0, [], dims);
            [functional_1_globa_2, functional_1_globa_2NumDims] = test_model.ops.onnxSqueeze(xMax, this.Vars.ReduceMaxAxes1013, Transpose__2072_0NumDims);

            % ReduceMean:
            dims = test_model.ops.prepareReduceArgs(this.Vars.ReduceMeanAxes1014, Transpose__2072_0NumDims);
            xMean = mean(Transpose__2072_0, dims);
            [functional_1_global_, functional_1_global_NumDims] = test_model.ops.onnxSqueeze(xMean, this.Vars.ReduceMeanAxes1014, Transpose__2072_0NumDims);

            % MatMul:
            [functional_1_dens_11, functional_1_dens_11NumDims] = test_model.ops.onnxMatMul(functional_1_global_, this.functional_1_dens_9, functional_1_global_NumDims, this.NumDims.functional_1_dens_9);
            ...
            % MatMul:
            [functional_1_dens_4, functional_1_dens_4NumDims] = test_model.ops.onnxMatMul(functional_1_global_, this.functional_1_dens_2, functional_1_global_NumDims, this.NumDims.functional_1_dens_2);
            ...
            % MatMul:
            [functional_1_type__3, functional_1_type__3NumDims] = test_model.ops.onnxMatMul(functional_1_dens_3, this.functional_1_type__2, functional_1_dens_3NumDims, this.NumDims.functional_1_type__2);
            ...
            % Concat:
            [functional_1_concate, functional_1_concateNumDims] = test_model.ops.onnxConcat(1, {functional_1_batc_3, functional_1_globa_2, functional_1_globa_1, functional_1_globa_3}, [functional_1_batc_3NumDims, functional_1_globa_2NumDims, functional_1_globa_1NumDims, functional_1_globa_3NumDims]);

            % MatMul:
            [functional_1_dens_18, functional_1_dens_18NumDims] = test_model.ops.onnxMatMul(functional_1_concate, this.functional_1_dens_16, functional_1_concateNumDims, this.NumDims.functional_1_dens_16);
            ...
            % MatMul:
            [functional_1_dens_25, functional_1_dens_25NumDims] = test_model.ops.onnxMatMul(functional_1_batc_7, this.functional_1_dens_23, functional_1_batc_7NumDims, this.NumDims.functional_1_dens_23);
            ...
            % MatMul:
            [functional_1_dista_3, functional_1_dista_3NumDims] = test_model.ops.onnxMatMul(functional_1_dens_24, this.functional_1_dista_2, functional_1_dens_24NumDims, this.NumDims.functional_1_dista_2);
