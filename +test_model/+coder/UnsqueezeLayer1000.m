classdef UnsqueezeLayer1000 < nnet.layer.Layer & nnet.layer.Formattable
    ...
    methods
        ...
        function [functional_58_1_c_2] = predict(this, feature_input__, feature_inputNumDims__)
            ...
            [functional_58_1_c_2__, functional_58_1_c_2NumDims__] = UnsqueezeGraph1000(this, feature_input, feature_inputNumDims, false);
            functional_58_1_c_2_ = test_model.coder.ops.permuteOutputVar(functional_58_1_c_2__, [2 3 4 1], 4);

            functional_58_1_c_2 = dlarray(single(functional_58_1_c_2_), 'SSCB');
        end
        ...
        function [functional_58_1_c_2, functional_58_1_c_2NumDims1001] = UnsqueezeGraph1000(this, feature_input, feature_inputNumDims, Training)
            ...
            % Unsqueeze:
            [shape1000, functional_58_1_c_2NumDims] = test_model.coder.ops.prepareUnsqueezeArgs(feature_input, this.Vars.const_fold_opt__62, coder.const(feature_inputNumDims));
            functional_58_1_c_2 = reshape(feature_input, shape1000);
