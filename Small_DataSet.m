    ...
    for load_p = Load
        for NR = NR_values
            for interface1 = Interface
                ...
                storage_bucket_switching_1{i} = T_mini;
                i = i + 1;
            end
        end
    end
    ...
    for load_p = Load
        for NR = NR_values
            for interface4 = Interface
                ...
                storage_bucket_switching_4{z} = T_mini;
                z = z + 1;
            end
        end
    end
...
save("Training_Dataset_small.mat", "Training_Dataset_temp");
parquetwrite("Training_Dataset_small.parquet", Training_Dataset_temp);