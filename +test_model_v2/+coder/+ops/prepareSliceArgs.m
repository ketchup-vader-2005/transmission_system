...
Starts = test_model_v2.coder.ops.extractIfDlarray(Starts_);
Ends = test_model_v2.coder.ops.extractIfDlarray(Ends_);
Axes_ = test_model_v2.coder.ops.extractIfDlarray(Axes__);
Steps_ = test_model_v2.coder.ops.extractIfDlarray(Steps__);
